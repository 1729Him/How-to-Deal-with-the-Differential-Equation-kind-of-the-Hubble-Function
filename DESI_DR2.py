...
# ------------------------------------------------------------------------------
# Load and Prepare the BAO Dataset from DESI DR2 for Likelihood Analysis
# ------------------------------------------------------------------------------

# This script utilizes Baryon Acoustic Oscillation (BAO) measurements from the
# Dark Energy Spectroscopic Instrument (DESI) Data Release 2 (DR2), which includes
# data from more than 14 million galaxies and quasars. These measurements provide
# powerful constraints on the expansion history of the Universe and are essential
# for precision cosmology.

# --------------------------------------------------------------------------------
# Citing the Data and Methodology:
#
# If you use this dataset or methodology in your analysis, please cite:
#
# - DESI Collaboration (2025), https://doi.org/10.48550/arXiv.2503.14738
#
# This paper presents the latest BAO measurements from DESI DR2.
# --------------------------------------------------------------------------------
